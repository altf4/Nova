...
QUERY="CREATE DATABASE nova_credentials; USE nova_credentials; CREATE TABLE credentials(user VARCHAR(10), pass VARCHAR(50)); INSERT INTO credentials VALUE('nova', SHA1('toor'));"
