...
void OsPersonalityDbBinding::Init(v8::Handle<Object> target)
{
  ...
  tpl->PrototypeTemplate()->Set(String::NewSymbol("GetPersonalityOptions"),FunctionTemplate::New(InvokeWrappedMethod<std::vector<std::string>, OsPersonalityDbBinding, OsPersonalityDb, &OsPersonalityDb::GetPersonalityOptions>));
