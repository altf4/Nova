...
public:
    ...
    dialogPrompt(enum dialogType, const QString &title, const QString &text = "", QWidget *parent = 0);
    ...
    dialogPrompt(enum dialogType, QAction * defaultAction, QAction * alternativeAction,
