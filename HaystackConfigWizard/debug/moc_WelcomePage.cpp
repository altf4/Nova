...
**
** Created: Tue Jun 26 17:32:20 2012
...
static const char qt_meta_stringdata_WelcomePage[] = {
    "WelcomePage\0"
};

const QMetaObject WelcomePage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_WelcomePage,
      qt_meta_data_WelcomePage, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &WelcomePage::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WelcomePage))
